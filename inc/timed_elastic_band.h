#ifndef TEB_TIMED_ELASTIC_BAND_H
#define TEB_TIMED_ELASTIC_BAND_H
...
// G2O Types
#include "../inc/g2o_types/vertex_pose.h"
#include "../inc/g2o_types/vertex_timediff.h"
 ...
 */
    ...
    public:
        ...
        */
        ...
        bool initTEBtoGoal(const std::vector<PoseStamped>& plan, double dt, bool estimate_orient=false, int min_samples = 3, bool guess_backwards_motion = false)
        {
...
#endif //TEB_TIMED_ELASTIC_BAND_H
